@if($galleryItems->count())
    ...
    <section id="gallery" class="gallery  {{ request()->routeIs('gallery') ? '' : 'section' }} vayu-gallery">
                                    ...
                                    <div class="reel-card">
                                        <div class="reel-frame">
                                            ...
                                            @elseif($item->youtube_id || $item->embed_url)
                                                <iframe {{ asset('public/storage'.$item->embed_url }}" title="{{ $item->title ?: 'Vayu Clinic video' }}"
                                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                                    allowfullscreen loading="lazy"></iframe>
                                            @elseif($item->is_direct_video)
                                                <video controls playsinline preload="metadata">
                                                    <source {{ asset('public/storage'.$item->video_url }}">
                                                </video>
                                            @else
