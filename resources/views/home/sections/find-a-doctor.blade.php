                            ...
                            <div class="testimonial-card">
                                ...
                                <div class="d-flex align-items-center mt-4 gap-3">
                                    <div class="avatar-wrapper">
                                        <img {{ asset('public/storage'.$testimonial->image ? asset($testimonial->image) : asset('public/assets/img/avatar.jpg') }}"
                    ...
                    <div class="doctor-profile" data-aos="zoom-in" data-aos-delay="{{ 100 + $loop->index * 100 }}">
                        <div class="profile-header">
                            <div class="doctor-avatar">
                                <img {{ asset('public/storage'.$doctor->image_url }}" alt="{{ $doctor->name }}" class="img-fluid">
