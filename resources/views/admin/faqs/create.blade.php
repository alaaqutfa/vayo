...
@section('content')
    <div class="px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8 flex flex-wrap items-center justify-between gap-4">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Add New FAQ</h1>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Create a frequently asked question with answer</p>
            </div>
        ...
        <div
            ...
            <div class="border-b border-gray-200 px-6 py-4 dark:border-gray-700">
                <h2 class="text-xl font-semibold text-gray-800 dark:text-white">FAQ Details</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">Fill in the form to add a new FAQ.</p>
            </div>
            <div class="px-6 py-6">
                <form action="{{ route('admin.faqs.store') }}" method="POST">
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="grid gap-6 sm:grid-cols-2">
                            <div>
                                <label for="question"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Question <span
                                ...
                                <input type="text" name="question" id="question" value="{{ old('question') }}"
                                    ...
                                    required>
                                @error('question') <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                <label for="order"
                        ...
                        <div>
                            ...
                            @error('answer') <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mt-8 flex justify-end border-t border-gray-200 pt-6 dark:border-gray-700">
                        <button type="submit"
                            ...
                            <i class="bi bi-check-lg mr-2 text-lg"></i> Create FAQ
                        </button>
                    </div>
                </form>
            </div>
