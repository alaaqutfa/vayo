...
@section('content')
    <div class="px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8 flex flex-wrap items-center justify-between gap-4">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Add New Page</h1>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Create a custom page with rich content</p>
            </div>
        ...
        <div
            ...
            <div class="border-b border-gray-200 px-6 py-4 dark:border-gray-700">
                <h2 class="text-xl font-semibold text-gray-800 dark:text-white">Page Details</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">Fill in the form to create a new page.</p>
            </div>
            <div class="px-6 py-6">
                <form action="{{ route('admin.pages.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-8">
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400">PNG, JPG, WEBP up to 2MB
                                        (recommended: 1200x800)</p>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <textarea name="meta_description" id="meta_description" rows="3"
                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-primary focus:ring-primary dark:border-gray-600 dark:bg-gray-700 dark:text-white sm:text-sm">{{ old('meta_description') }}</textarea>
                    ...
                    <div class="mt-8 flex justify-end border-t border-gray-200 pt-6 dark:border-gray-700">
                        <button type="submit"
                            ...
                            <i class="bi bi-check-lg mr-2 text-lg"></i> Create Page
                        </button>
                    </div>
                </form>
            </div>
