                    ...
                    @foreach($services as $service)
                        <tr class="transition-colors hover:bg-gray-50 dark:hover:bg-gray-800/50">
                            ...
                            <td class="whitespace-nowrap px-4 py-4 text-sm text-gray-500 dark:text-gray-400">
                                @if($service->image)
                                    <img src="src="{{ asset('public/storage'.$service->image) }}" class="h-10 w-10 rounded-lg object-cover shadow-sm">
                                @else
                                    <span class="inline-block h-10 w-10 rounded-lg bg-gray-100 dark:bg-gray-700"></span>
                                @endif
                            </td>
                            <td class="whitespace-nowrap px-4 py-4 text-sm font-medium text-gray-900 dark:text-white">{{ $service->name }}</td>
                            <td class="whitespace-nowrap px-4 py-4 text-sm text-gray-500 dark:text-gray-400">{{ $service->slug }}</td>
                            <td class="whitespace-nowrap px-4 py-4 text-sm text-gray-500 dark:text-gray-400">
                                @if($service->icon)
                            ...
                            <td class="whitespace-nowrap px-4 py-4 text-sm text-gray-500 dark:text-gray-400">{{ $service->order }}</td>
