    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-8 flex flex-wrap items-center justify-between gap-4">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Create a new medical service offering</p>
            </div>
        ...
        <div
            ...
            <div class="border-b border-gray-200 px-6 py-4 dark:border-gray-700">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">Fill in the details below to create a new service.</p>
            </div>
            <div class="px-6 py-6">
                <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                        <div class="space-y-6">
                            ...
                            <div>
                                <label for="icon" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Icon
                                    (CSS class)</label>
                                ...
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Use Bootstrap Icons class (e.g., bi
                                    bi-briefcase)</p>
                            ...
                            <div>
                                <label for="image"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Service Image</label>
                                <div
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Features (key
                                    points)</label>
                                    ...
                                    @if(old('features'))
                                        @foreach(old('features') as $feature)
                                            <div class="feature-row flex gap-2">
                                                ...
                                                <button type="button"
                                                    class="remove-feature rounded-lg bg-red-100 px-3 py-2 text-sm text-red-700 transition-colors hover:bg-red-200 dark:bg-red-900/30 dark:text-red-300 dark:hover:bg-red-900/50">Remove</button>
                                            </div>
                                        @endforeach
                                    @else
                                        <div class="feature-row flex gap-2">
                                            <input type="text" name="features[]" placeholder="e.g., 24/7 Emergency Cardiac Care"
                                                class="flex-1 rounded-lg border-gray-300 shadow-sm focus:border-primary focus:ring-primary dark:border-gray-600 dark:bg-gray-700 dark:text-white sm:text-sm">
                                            <button type="button"
                                                class="remove-feature hidden rounded-lg bg-red-100 px-3 py-2 text-sm text-red-700 transition-colors hover:bg-red-200 dark:bg-red-900/30 dark:text-red-300 dark:hover:bg-red-900/50">Remove</button>
                                        </div>
                                    @endif
                                </div>
                    ...
                    <div class="mt-8 flex justify-end border-t border-gray-200 pt-6 dark:border-gray-700">
                        <button type="submit"
                            ...
                            <i class="bi bi-check-lg mr-2 text-lg"></i> Create Service
                        </button>
                    </div>
                </form>
            </div>
